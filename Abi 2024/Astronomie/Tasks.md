...
- Absorptionsspektrum
- Emissionsspektrum
2. Nennen Sie die Einteilung der Sterne nach ihrer Oberflächentemperatur.
- O, B, A, F, G, K, M
3. Die Spektralklasse O und B sind sehr heiße Sterne. Nennen Sie den Temperaturbereich der Sternoberfläche der genannten Spektralklassen, wie sie in der Tabelle der Sternklassen beschrieben sind.
- 30000 - 5000 Kelvin
- 10000 - 28000 Kelvin
4. Beschreiben Sie Eingenschaften der kühlsten Sterne, die sie in der Tabelle finden, und nennen Sie die entsprechende Sternklasse.
- Braune Zwerge
	- 200 - 2000 Kelvin
	- Extrem Klein
...
2. Beschreiben Sie die Einordnung unserer Sonne in beiden Kategorien.
- G-Klasse
---
$r=149.6*10^9m$
$S=1367\frac{W}{m^2}$
